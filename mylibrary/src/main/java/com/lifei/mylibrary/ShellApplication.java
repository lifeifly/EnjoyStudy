    ...
    private static final class V19{
        ...
        private static void install(ClassLoader classLoader,List<File> additionalClassPathEntries,File optimizedDirectory) throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            ...
            if (Build.VERSION.SDK_INT>=23){
                expandFieldArray(dexPathList,"dexElements",makePathElements(dexPathList,new ArrayList<>(additionalClassPathEntries),optimizedDirectory,suppressedExceptions));
            }else {
        ...
        private static void expandFieldArray(Object instance, String fieldName, Object[] extraElements) throws NoSuchFieldException, IllegalAccessException {
        ...
        private static Object[] makePathElements(Object dexPathList, ArrayList<File> files,File optimizedDirectory,
            ...
            try {
                makePathElements=findMethod(dexPathList,"makePathElements",List.class,File.class,List.class);
            } catch (NoSuchMethodException e) {
        ...
        private static Object[] makeDexElements(Object dexPathList,
            ...
            Method makeDexElements = findMethod(dexPathList, "makeDexElements", new Class[]{ArrayList.class, File.class, ArrayList.class});
            return ((Object[]) makeDexElements.invoke(dexPathList, new Object[]{files,
                    optimizedDirectory, suppressedExceptions}));
        }
        private static Method findMethod(Object o, String methodName,Class...argv) throws NoSuchMethodException {
            Class c=o.getClass();
            while (c != null) {
                try {
                    Method e = c.getDeclaredMethod(methodName, argv);
                    if (!e.isAccessible()) {
            ...
            throw new NoSuchMethodException("Method " + methodName + " with parameters " + Arrays.asList
                    (argv) + " not found in " + o.getClass());
        }
